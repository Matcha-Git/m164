...
-----------------------------------------------------------
update Bike 
	set fk_TypId = (select TypId from Typ where Typ.Bez = 'Citybike'),
		fk_MarkeId = (select MarkeId from Marke where Marke.Bez = 'Cube')
	where Bike.Bez = 'Travel SL';
